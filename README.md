...
- [x] 7.0 Улучшить визуальную часть игры (Артур / L0)
- [x] 7.1 Настроить Express для Server Side Rendering (Анна / L3)
- [x] 7.2 Настроить Redux и Router в SSR (Артур / L4)
- [ ] 7.3 Добавить OAuth-авторизацию в проект (Кирилл / L3)
- [ ] 7.4 Добавить API для лидерборда (Сергей / L2)

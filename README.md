...
[ ] 5.3.2 Сверстана страница игры после логина (Кирилл / L1)
...
[ ] 6.5 Авторизация проверяется через отдельный Hook / HOC (Сергей + Кирилл, / L1)
...
[ ] 7.0 Улучшить визуальную часть игры (? / L0)
[ ] 7.1 Настроить Express для Server Side Rendering (Анна / L3)
[ ] 7.2 Настроить Redux и Router в SSR (? / L4)
[ ] 7.3 Добавить OAuth-авторизацию в проект (? / L3)
[ ] 7.4 Добавить API для лидерборда (? / L2)
[ ] 7.5 Добавить ещё один WEB API (кроме Canvas, Fetch) (? / L2)
[ ] 7.6 Добавить в проект MEMORYLEAKS.md / новый раздел в README.md (? / L1)

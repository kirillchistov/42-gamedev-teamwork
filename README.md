...
- [x] 7.1 Настроить Express для Server Side Rendering (Кирилл / L3)
- [ ] 7.2 Настроить Redux и Router в SSR (Артур / L4)
- [ ] 7.3 Добавить OAuth-авторизацию в проект (Анна / L3)
- [ ] 7.4 Добавить API для лидерборда (Сергей / L2)
- [ ] 7.5 Добавить ещё один WEB API (кроме Canvas, Fetch) (Кирилл / L2)
- [x] 7.6 Добавить в проект MEMORYLEAKS.md / новый раздел в README.md (Кирилл / L1)

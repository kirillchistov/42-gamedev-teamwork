...
- [x] 7.5 Добавлен Performance API (Антон / L2)
- [x] 7.6 Добавлен MEMORYLEAKS.md (Кирилл / L1)

**Спринт 8 (форум, темизация)**
- [x] 8.1 Настроить Docker для Postgres (Кирилл / L2)
- [x] 8.2 Реализовать API для форума (Кирилл / L5)
- [x] 8.3 Переключение тем (клиент) (Артур / L3)
- [x] 8.4 Проверка авторизации на бекэнде (Сергей / L3)
- [x] 8.5 Эмодзи (клиент) (Артур / L2)
- [x] 8.6 Эмодзи (бэкенд) (Сергей / L2)
- [x] 8.7 Переключение темы (бэкенд) (Анна / L2)
- [x] 8.8 Серверная инфраструктура для форума (Анна / L5)
- [x] 8.9 Поддержать API форума на клиенте (Антон / L3)

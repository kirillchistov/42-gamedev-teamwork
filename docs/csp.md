...
CSP ограничивает, откуда браузер может грузить скрипты, стили, запросы и картинки. Это снижает риск XSS: даже если в страницу попадёт чужой скрипт, браузер его не выполнит без разрешения в политике.
...
На edge можно оставить CSP от Node или задать ту же строку в nginx — важно не ослаблять политику на проде.

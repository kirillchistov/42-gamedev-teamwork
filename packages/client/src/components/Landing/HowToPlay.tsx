  ...
  const cards = [
    {
      ...
      desc: 'Меняйте соседние фишки местами и собирайте цепочки 3+.',
      badge: '3x',
      screenText: 'Три одинаковых в ряд',
    },
    {
      title: 'Мега-комбо',
      desc: 'Длинные каскады ускоряют набор очков и дают игровойбуст.',
      badge: 'x8',
      screenText: 'Каскад + взрыв + бонус',
    },
    {
      title: 'Бустеры',
      desc: 'Эффекты линий и зон помогают проходить сложные квесты.',
      badge: 'BOOST',
      screenText: 'Линия, крест и зона',
    },
    {
      title: 'Блокеры',
      desc: 'Спец-клетки и препятствия требуют точных попаданий.',
      badge: 'LOCK',

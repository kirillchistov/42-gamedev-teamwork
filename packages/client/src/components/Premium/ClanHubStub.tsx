  ...
  return (
    <section className="premium-card">
      ...
      <div className="premium-meta-row">
        <span className="premium-soft-note">Участников онлайн: 142</span>
        <span className="premium-soft-note">Клановый сезон: 9 дней</span>
      </div>
      <div className="premium-grid premium-grid--3">
        <div className="premium-panel">
          ...
          <p className="premium-muted">Создать или вступить в клан.</p>
          <ul>
          ...
          <div className="premium-stack">
            ...
            <Button variant="outline">Вступить по коду</Button>
          </div>
        </div>
        <div className="premium-panel">
          <div className="premium-panel__header">
          ...
          <Button variant="outline">Показать награды</Button>
        </div>
        <div className="premium-panel">
          <div className="premium-panel__header">
          ...
          <ul>
            <li>Эмблема клана - 120 кристаллов</li>
            <li>Баннер сезона - 80 кристаллов</li>
            <li>Рамка профиля - 60 кристаллов</li>
          </ul>
          <Button variant="flat">Открыть витрину</Button>
        </div>
      </div>
    </section>
  )

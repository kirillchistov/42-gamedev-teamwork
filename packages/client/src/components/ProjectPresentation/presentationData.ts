...
export const LEARNING_GALAXY = [
  {
    ...
    y: 16,
    planets: [
      { label: 'Декомпозиция', angleDeg: -50, radiusPct: 12 },
      { label: 'Тесты', angleDeg: -12, radiusPct: 12 },
  ...
  },
  {
    ...
    y: 16,
    planets: [
      { label: 'Коммуникация', angleDeg: -50, radiusPct: 12 },
      { label: 'Внутренние ревью', angleDeg: 8, radiusPct: 12 },
      { label: 'Стандарты кодинга', angleDeg: 56, radiusPct: 12 },
    ],
  },
  {
    id: 'time',
    ...
    planets: [
      ...
      { label: 'Приоритеты', angleDeg: 5, radiusPct: 12 },
  ...
  },
  {
    ...
    y: 74,
    planets: [
      { label: 'Самообучение', angleDeg: -48, radiusPct: 12 },
      { label: 'Документация', angleDeg: -18, radiusPct: 12 },
      { label: 'Освоение разных API', angleDeg: 12, radiusPct: 12 },
      { label: 'Эксперименты', angleDeg: 44, radiusPct: 12 },
    ],
  },
] as const

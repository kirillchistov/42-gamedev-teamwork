// Цель: Создание игрового поля и сетки
// - Клетки - целые числа
//   0..KINDS-1  = цвет и тип клетки
//   -1 = пустая клетка (после уборки, до гравитации и замены)
// - На старте не должно быть готовых комбинаций

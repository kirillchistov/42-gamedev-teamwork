...
import { LogoutPage, initLogoutPage } from './pages/LogoutPage'
...
import { PremiumPage, initPremiumPage } from './pages/Premium'
import {
  PresentationPage,
...
export type PageInitFn = (args: PageInitArgs) => Promise<unknown> | void
...
export const routes: AppRoute[] = [
  ...
  },
  {
    ...
    fetchData: initPresentationPage,
  },
  {
